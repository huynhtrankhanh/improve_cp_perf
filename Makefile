...
Makeifle.conf: _CoqProject
	coq_makefile -f _CoqProject -o Makeifle

# This file can be created by the user to hook into double colon rules or
# add any other Makefile code he may need
-include Makeifle.local

# Parameters ##################################################################
#
# Parameters are make variable assignments.
# They can be passed to (each call to) make on the command line.
# They can also be put in Makeifle.local once and for all.
...
# put in Makeifle.local double colon rules accordingly.
...
#
# There rules can be extended in Makeifle.local
...
# extension points and Makeifle.local
printenv::
	$(warning printenv is deprecated)
	$(warning write extensions in Makeifle.local or include Makeifle.conf)
	@echo 'COQLIB = $(COQLIB)'
...
# file you can extend the merlin-hook target in Makeifle.local
.merlin:
	$(SHOW)'FILL .merlin'
...
# Users can create Makeifle.local-late to hook into double-colon rules
# or add other needed Makefile code, using defined
# variables if necessary.
-include Makeifle.local-late
